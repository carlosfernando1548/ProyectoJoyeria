...
CREATE TABLE `clientes` (
  ...
  `cli_tipo` int(11) NOT NULL DEFAULT '0',
  `cli_correo` varchar(200) DEFAULT NULL,
  `cli_perfil` varchar(400) DEFAULT NULL,
  PRIMARY KEY (`cli_id`)
...
INSERT INTO `clientes` VALUES (1,'Administrado','Administrado','SIN DOMICILIO',1,1,'admin@tienda.com','noimage');
...
-- Dump completed on 2017-07-22 23:51:00

        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="bkng-tb-cntnt">
                    <div class="pymnts">
                        <form action="{{url('pagos/pagar')}}" method="POST" id="payment-form">
                            {{ csrf_field() }}
                                ...
                                <div class="pymnt-cntnt">
                                    ...
                                    <div class="sctn-row">
                                        ...
                                        <div class="sctn-col">
                                            ...
                                            <input type="text" required name="numTarjeta" autocomplete="off" data-openpay-card="card_number"></div>
                                        </div>
                                        <div class="sctn-row">
                                            <div class="sctn-col l">
                                    ...
                                    <div class="sctn-row">
                                        <a onclick="document.getElementById('payment-form').submit();" class="button rght" id="pay-button">Pagar</a>
                                    </div>
                                </div>
                            </div>
                        </form>

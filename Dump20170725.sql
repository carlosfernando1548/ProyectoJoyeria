...
INSERT INTO `carrito` VALUES (1,1,'2017-07-23 21:55:51',0,2),(2,1,'2017-07-23 22:11:35',0,2),(3,2,'2017-07-23 22:16:25',0,2),(4,3,'2017-07-23 22:18:35',0,2),(5,2,'2017-07-23 22:47:58',0,2),(6,1,'2017-07-23 22:59:30',0,2);
...
INSERT INTO `comentarios` VALUES (1,'Hola hola',1,1,'2017-07-24 23:46:13',1),(2,'casd',1,0,'2017-07-25 00:15:21',1),(3,'carlos moraes',1,1,'2017-07-25 00:18:26',9);
...
/*!50001 VIEW `vw_carrito` AS (select count(`c`.`pro_id`) AS `cantidad`,`p`.`pro_id` AS `pro_id`,`p`.`pro_nombre` AS `pro_nombre`,(count(`c`.`pro_id`) * `p`.`pro_costo`) AS `total`,`c`.`cli_id` AS `cli_id` from (`carrito` `c` join `productos` `p` on((`p`.`pro_id` = `c`.`pro_id`))) where (`c`.`car_estado` = 0) group by `p`.`pro_id`) */;
